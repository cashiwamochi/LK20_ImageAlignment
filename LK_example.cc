...
int main(int argc, char* argv[]) {
  ...
  LK20::LKTracker _tracker(image, track_rect, 3, LK20::FC, LK20::SE3);

  // tx, ty, tz, rx, ry, rz
  cv::Mat warped_image = _simulator.GenerateWarpedImage(-10, 5, 5, 20, -20, -15);
  // cv::Mat warped_image = _simulator.GenerateWarpedImage(-45, -25, 20, 30, -30, -50);
